...
if len(good)>MIN_MATCH_COUNT:
    ...
    print("SURF MATCH! - %d/%d" % (len(good),MIN_MATCH_COUNT))

else:
    print("SURF Not enough matches are found - %d/%d" % (len(good),MIN_MATCH_COUNT))
    matchesMask = None
    FLAG = 0
...
if len(good)>MIN_MATCH_COUNT:
    ...
    print("SIFT MATCH! - %d/%d" % (len(good),MIN_MATCH_COUNT))
